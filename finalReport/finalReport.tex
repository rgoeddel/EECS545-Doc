...
%    -- move final paragraph to methodology
%-- Methodology
...
We use supervised learning to generate a description of each object in the ``play
area'' using training data we collected to predict descriptions of new objects.

We gathered our own training data by collecting hundreds of RGBD frames of objects
of each color, size, and shape in varying positions. Each object is manually
labeled with descriptors that include color, shape, and size, and these labels
were saved with their corresponding feature vectors.

...
segments objects from the scene and allows a human to label these objects
with relevant descriptors.
...
classification did not perform very well. The results in
Table~\ref{tbl:testresults} show plenty of room for improvement. This should
